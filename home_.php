...
wp_reset_query(); ?>
				...
				<div id="left_future">
					...
					//       NEWS
					// *****************
					$postslist = get_posts('category_name=news&cat=-21&numberposts=1&orderby=date');
					...
					<span class="date"><?php the_date('d-M-y'); ?>&nbsp;&nbsp;&mdash;&nbsp;&nbsp;</span>
			...
			<div id="left_middle">
				...
				<div id="left_recent">
					<h2><a href="<?php bloginfo('wpurl'); ?>/archives/">recent events</a></h2>
					...
					//  RECENT EVENTS
					// ***************** 
						$postslist = get_posts('category_name=archives&numberposts=3&orderby=date');
						foreach ($postslist as $post) : 
						setup_postdata($post)
						?> 
				...
				<h3><a href="<?php bloginfo('wpurl'); ?>/archives/">&gt;&gt; see more events</a></h3>
				</div><!--END#left_recent -->
			</div><!--END#left_middle -->
		</div><!--END#left_box-->
		...
		<div id="right_box">
			...
			<div id="right_middle">
				<div id="right_download">
					<h2>downloads</h2>
					<p>coming very soon to your harddrive...</p>
			...
			<div id="right_credits">
				...
				<div>
				<a href="http://www.bak.admin.ch/themen/kulturfoerderung/00476/index.html" target="_blank"><img class="OFC" src="<?php bloginfo('stylesheet_directory'); ?>/images/OFC_bw.png"/></a>
